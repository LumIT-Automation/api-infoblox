...
from .controllers.Infoblox import NetworksTree, NetworkContainers, NetworkContainer, Network, Networks, Ipv4, Ipv4s
...
urlpatterns = [
    ...
    path('<int:assetId>/network-container/<str:networkAddress>/<str:mask>/networks/', NetworkContainer.InfobloxNetworkContainerNetworksController.as_view(), name='infoblox-network-container-info'),
